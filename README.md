...
This guide was initially written with translators in mind, but the information is relevant to all technical writers at Accuray. For complete information, see Accuray's *Corporate Style Guidelines*, *Style Guide*, the *Microsoft Manual of Style*, and the *AP Style Guide*.
